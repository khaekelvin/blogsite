    ...
    return (
        <>
            <div className="max-w-7xl mx-auto my-10">
                <div className="foot lg:flex rounded-xl h-auto md:h-[350px] mx-2 md:mx-0">
                    <div className="lg:flex lg:max-w-5xl lg:mx-auto lg:justify-center">
                        <div className="lg:w-[500px] lg:mx-0 mx-auto pl-5">
                            <p className="text-white lg:text-6xl text-5xl pt-10 lg:mb-0 mb-5 leading-[60px] lg:my-auto">
                                Transforming your <b>Ideas into reality</b>
                            </p>
                            <p className="text-white text-xl lg:pt-5">
